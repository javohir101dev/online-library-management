...
<section>
    <H1 class="text-uppercase text-center mb-4" style="font-family: 'Times New Roman';">Search Authors result</H1>
</section>
            ...
            <tr>
                ...
                <td>
                    <form action="/author/delete" method="post">
                        <button class="btn btn-danger" type="submit" value="${author.id}" name="authorId">Delete
                        </button>
                    </form>
                </td>
            </tr>
