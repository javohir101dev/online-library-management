                ...
                <div class="card-body p-md-5">
                    <div class="row justify-content-center">
                        <div class="col-md-10 col-lg-7 col-xl-7 order-2 order-lg-5">
                            <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Receiving Book from User</p>

                            <form action="/book-user/take" method="post" class="mx-1 mx-md-4">
                                ...
                                <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                                    <button type="submit" class="btn btn-primary btn-lg">Receive</button>
                                </div>
                            </form>
                        </div>
                    </div>
